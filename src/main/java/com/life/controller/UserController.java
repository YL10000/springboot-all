...
public class UserController {
  ...
  @PostMapping("add")
  public Boolean addUser(@RequestBody @Validated UserEntity userEntity) {
  ...
  public Page<UserEntity> pageuser(@PathVariable("pageNum") int pageNum, @PathVariable("pageSize") int pageSize) {
